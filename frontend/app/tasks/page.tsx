      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            {/* Step 2: Voice note after task created */}
            {showModalAudio && createdTaskId && currentUser && (
              <div className="p-5 space-y-3">
                ...
                <button onClick={resetModal}
                  className="w-full py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50">
                  Done, Close
                </button>
              </div>
            )}
              ...
              <form onSubmit={handleSubmit} className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <input type="date" value={form.due_date}
                    ...
                    onChange={e => setForm(p => ({ ...p, due_date: e.target.value, selectedDept: '', selectedUsers: [] }))}
                    className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    <span className="flex items-center gap-1.5"><Building2 size={14} /> Department *</span>
                  </label>
                  <select
                ...
                {/* Step 2: Members of that department */}
                {form.selectedDept && (
                  <div>
